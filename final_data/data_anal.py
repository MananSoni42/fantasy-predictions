...
for i,name in enumerate(names):
    ...
    lolmax.append([name,av1,av2,av3,av4,av5])    
#print(player_form[axar-patel].groupby('batting').median())
lolmax=pd.DataFrame(lolmax)
lolmax.columns=["Player-name","Average Points","Average Batting-Runs","Average wicket per match","Average sr","Average bowl econ"]
print(lolmax)
#pprint(player_form)
