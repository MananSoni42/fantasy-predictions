...
def stadium_records(stadium_url):
    ...
    stadium_record['stadium_name']=current_header
...
data=[stadium_record_store['stadium_name'],stadium_record_store['Bat_Statistic'],stadium_record_store['Bat_All-time'],stadium_record_store['Bat_2021']]
pprint(data)
